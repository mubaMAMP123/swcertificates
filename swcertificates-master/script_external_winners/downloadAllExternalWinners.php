...
// select the external winners folder to be downloaded
$pathdir = "../certificates/$event_id/external_winners/";

// name the zip folder
$zipcreated = "$event_name External Winners' Certificates.zip";
// zip all files
$zip = new ZipArchive;
