...
// get guest id, event id & user account type
...
$SELECT = "SELECT event_name,event_organiser,event_date,guest_name,guest_email FROM events INNER JOIN guests ON events.event_id = guests.event_id WHERE guest_id='" . $guest_id . "' AND generate_status=1";
