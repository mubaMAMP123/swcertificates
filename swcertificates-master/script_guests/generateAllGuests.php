...
$SELECT = "SELECT event_name,event_organiser,event_date,guest_id,guest_name FROM events INNER JOIN guests ON events.event_id = guests.event_id WHERE approval_status=1 AND generate_status=0";
...
// generate certificate for all guests
