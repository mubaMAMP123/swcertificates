...
// get internal participant id, event id and approval status
...
// update approval status of the internal participant
$UPDATE = "UPDATE " . $event_id . " SET approval_status='" . $status . "', approved_by='" . $approved_by . "', approved_at='" . $approved_at . "' WHERE entry_id = '" . $internal_participant_id . "' AND request_status=1 AND approval_status=0";
