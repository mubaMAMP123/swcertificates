...
// select the internal participants folder to be downloaded
$pathdir = "../certificates/$event_id/internal_participants/";

// name the zip folder
$zipcreated = "$event_name Internal Participants' Certificates.zip";
// zip all files
$zip = new ZipArchive;
