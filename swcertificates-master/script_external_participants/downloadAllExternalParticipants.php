...
// select the external participants folder to be downloaded
$pathdir = "../certificates/$event_id/external_participants/";

// name the zip folder
$zipcreated = "$event_name External Participants' Certificates.zip";
// zip all files
$zip = new ZipArchive;
