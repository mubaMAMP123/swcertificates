...
// get external participant id, event id & user account type
...
$SELECT = "SELECT event_name,event_organiser,event_date,entry_name,entry_email,entry_college,certificate_number,verification_link FROM events INNER JOIN " . $event_id . " ON events.event_id = " . $event_id . ".event_id WHERE entry_id='" . $external_participant_id . "' AND generate_status=1";
